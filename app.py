...
# GMT+8 > 10:30pm - 5am
trigger = OrTrigger([
    CronTrigger(second='*/10', day_of_week='mon-fri', minute='30-59', hour='22-23', timezone='Asia/Singapore'),
    CronTrigger(second='*/10', day_of_week='tue-sat', hour='0-4', timezone='Asia/Singapore')
])
